              ...
              {(mode === 'signin' || mode === 'signup') && (
                <>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-white text-gray-900 py-3 rounded-xl font-medium hover:bg-gray-100 transition disabled:opacity-50 mb-4 flex items-center justify-center gap-3"
                  >
